<template>
  <div>
    ...
    <footer class="mx-auto max-w-5xl px-4 py-8 text-xs text-gray-600">
      <div class="space-y-2">
        <div class="text-sm font-medium text-gray-800">О проекте</div>
        <p>
          PriceCrowd — это краудсорсинговая платформа для сбора и анализа цен: сканирование QR-чеков, 
          сравнение товаров и магазинов, построение аналитики цен и рейтингов. 
          Сервис полностью открытый, работает через API ФНС России.
        </p>
        <p>
          Фронтенд: Vue 3 + Vite + Tailwind. Бэкенд: Rust (Axum) + MongoDB. 
          Интеграция с Telegram-ботом для загрузки чеков.
        </p>
        <div class="pt-2">
...
// Авторизован — если есть токен, имя и роль
